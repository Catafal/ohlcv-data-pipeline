#!/usr/bin/env python3
"""
Alpaca Data Pipeline Module
Handles data fetching, validation, and storage for Alpaca market data
"""
...
class AlpacaDataPipeline:
    """Main pipeline class for Alpaca data operations"""
    ...
    def _init_api(self):
        ...
        try:
            ...
            raise Exception(f"Failed to initialize Alpaca API: {e}")
    ...
    def _setup_logging(self):
        ...
        logging.basicConfig(
            ...
            handlers=[
                logging.FileHandler('logs/alpaca_pipeline.log'),
    ...
    def fetch_historical_data(self, symbol, start_date, end_date, timeframe='1Day'):
        ...
        try:
            ...
            # Add adj_close (same as close for raw data)
            bars['adj_close'] = bars['close']
            
            self.logger.info(f"Fetched {len(bars)} records for {symbol}")
            return bars
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("✅ AlpacaDataPipeline initialized successfully")
    except Exception as e:
